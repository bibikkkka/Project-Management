...
public interface ProjectManagerRole {
    ...
    @MenuPolicy(menuIds = {"User.list", "Project.list", "ProjectStats.list", "TimeEntry.list", "Task_.list"})
    @ViewPolicy(viewIds = {"User.list", "Project.list", "ProjectStats.list", "TimeEntry.list", "Task_.list", "Project.detail", "Task_.detail", "TimeEntry.detail", "User.detail"})
    void screens();
}